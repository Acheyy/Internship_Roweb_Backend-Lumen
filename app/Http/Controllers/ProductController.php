...
class ProductController extends Controller
{
    ...
    public function getSalePrice(){
        $promotions = Promo::whereHas('promoRelations', function ($query) use ($id) {
            $query->where('product_id', $id)
                ->orWhereHas('category', function ($query) use ($id) {
                    ...
                    $query->whereHas('subCategories', function($query) use ($id) {
                        $query->whereHas('products', function ($query) use ($id) {
                            $query->where('id', $id);
                        });
                    });                        
    ...
    public function create(Request $request)
    {
        try {
            ...
            if ($request->hasFile('photo')) {
                ...
                $imageName = base_path('public/uploads/').$request->file('photo')->getFilename(). '.' .$request->file('photo')->getClientOriginalExtension();
