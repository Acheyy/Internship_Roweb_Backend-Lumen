...
class UserController extends Controller
{
    ...
    /**
     *
     * TODO unnecesary, neede method to get all users
     * Return singleUser
     *
     * @return JsonResponse
     */
        ...
        try {
            if (User::isAdmin()) {
                ...
                $user->fill([
                    ...
                    'email' => $request->email,
                    'type' => $request->type,
                    //'picture' => $request->picture, //TODO why picture
                    'password' => \Illuminate\Support\Facades\Hash::make($request->password),
                ]);
                ...
                $user->save();
                return $this->returnSuccess($user);
            } //todo nu se intoarce nici un raspuns daca nu e admin
        } catch (\Exception $e) {
            return $this->returnError($e->getMessage(), ErrorCodes::FRAMEWORK_ERROR);
        }
    }
...
//            }
            ...
            } //todo nu se intoarce nimic daca nu e admin, bad practice
        } catch (\Exception $e) {
            return $this->returnError($e->getMessage(), ErrorCodes::FRAMEWORK_ERROR);
        }
    }
    ...
    public function delete($id)
    {
        try {
            ...
            if (User::isAdmin()) {
                $user->delete();
            }//todo pe else sa intoarca eroare
